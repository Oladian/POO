...
public class TestRightTriangle {
	public static void main(String[] args) {
		...
		double input1 = Double.parseDouble(JOptionPane.showInputDialog("Type cathetus 1"));
		double input2 = Double.parseDouble(JOptionPane.showInputDialog("Type cathetus 1"));
